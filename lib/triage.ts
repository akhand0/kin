...
// An explicit request for a person to review or contact the patient is a
// handoff request even when the symptom itself is not a clinical red flag.
// Keep this deliberately narrow: ordinary mentions of a GP/care team should
// not page a clinician unless the patient asks us to involve them.
